...
From the graph, I can tell that there is not very big difference between the accuracies on training data and on development data, and overall accuracies do not change much with the increment of iterations.
